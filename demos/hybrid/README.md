...
Before running, check the demo's own README for any required configuration. You may need to update values such as the Crazyflie URI or other settings directly in the Python script.
